import 'package:cmis/api/api_service.dart';
import 'package:cmis/model/login_model.dart';
import 'package:cmis/pages/DashboardEmployee_page.dart';
import 'package:cmis/pages/Registration_page.dart';
                        ...
                        FlatButton(
                          padding: EdgeInsets.symmetric(
                              ...
                              onPressed: () async {
                                ...
                                sharedprefernces.setString("token",token);
                                Navigator.of(context).push(MaterialPageRoute(builder: (context) => DashboardEmployee()));
