...
class InprocessComplains extends StatefulWidget {
  const InprocessComplains({Key key}) : super(key: key);

  @override
  State<InprocessComplains> createState() => _InprocessComplainsState();
}

class _InprocessComplainsState extends State<InprocessComplains> {
          ...
          appBar: new PreferredSize(
            child: new Container(
              ...
              child: new Padding(
                ...
                child: new Text(
                  Constants_english.InProcess+" Complains",
